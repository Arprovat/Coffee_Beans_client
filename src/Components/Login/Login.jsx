...
<input type="submit" className="bg-gradient-to-r from-blue-400 to-cyan-200 w-80 font-semibold rounded-full py-2" value="  Sign in" />
          </form>

          <div className="text-dull-white border-t border-white-light pt-4 space-y-4 text-sm">
            <p>
              Don't have an account? <Link to='/signup' className="text-neon-blue font-semibold cursor-pointer">Sign up</Link>
            </p>
            <p>
